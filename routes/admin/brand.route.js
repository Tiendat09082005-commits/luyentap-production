...
router.post("/create" , authMiddleware.checkPermission("brands_create"), upload.single('logo'), csrfMiddleware, uploadCloud.upload, brandMiddleware.validateCreateBrandMiddleware, controller.create);
...
router.post("/edit/:id" , authMiddleware.checkPermission("brands_edit"), upload.single('logo'), csrfMiddleware, uploadCloud.upload, brandMiddleware.validateEditBrandMiddleware, controller.edit);
